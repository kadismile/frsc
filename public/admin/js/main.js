jQuery(document).ready(function($){
    ...
    function triggerFilter($bool) {
        var elementsToTrigger = $([$('.cd-filter-trigger'), $('.cd-filter'), $('.tab-filter'), $('.cd-gallery')]);
    ...
    function fixGallery() {
        ...
        ( scrollTop >= offsetTop ) ? $('.filter-container').addClass('is-fixed') : $('.filter-container').removeClass('is-fixed');
    }
