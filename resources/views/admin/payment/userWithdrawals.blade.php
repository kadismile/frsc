        ...
        <div class="main-content">
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">Listing All Withdrawals </div>
                        <div class="card-body">
                            <table class="table table-bordered table-responsive">
                                ...
                                @foreach($withdrawals as $withdrawal)
                                    <?php $users = Helper::getUserById($withdrawal->user_id) ?>
                                    <tr>
                                        <th scope="row">{{$x++}}</th>
                                        ...
                                        {!! Form::model($withdrawal, ['route' => ['withdraw.update', $withdrawal->id], 'method' => 'PUT']) !!}
                                            {{--<input type="hidden" name="user_id" value="{{$withdrawal->user_id}}">
                                            <input type="hidden" name="amount" value="{{$withdrawal->amount}}">
                                            <input type="hidden" name="withdraw_from" value="{{$withdrawal->withdraw_from}}">--}}
